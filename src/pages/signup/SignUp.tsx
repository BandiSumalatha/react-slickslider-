...
import { ButtonGrid, CustomButton, StyledFormGroup } from "./signupStyles";
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { OuterContainer, Horizantal } from './signupStyles';
...
const SignUp: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        Object.entries(form).forEach(([key, value]) => {
            if (value.trim() === '') {
                isValid = false;
                newErrors[key as keyof FormValues] = `Please enter ${key === 'dob' ? 'Date of Birth' : key}`;
            }
        });
        ...
        if (form.password.trim() === '') {
            ...
            console.log('Password empty error set');
            ...
            console.log('Password validation error set');
        }
        if (form.confirmPassword.trim() === '') {
            isValid = false;
            newErrors.confirmPassword = "Please enter Confirm Password";
            console.log('Confirm password empty error set');
    ...
    return (
        <>
            ...
            <OuterContainer maxWidth="lg">
                <Horizantal>
                    <Typography  variant="h4" textAlign={"center"} p={4}>Registration Form</Typography>
                </Horizantal>
